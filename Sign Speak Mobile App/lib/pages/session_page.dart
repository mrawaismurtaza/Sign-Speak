...
// import 'package:sign_speak/pages/session_loading.dart';
import 'dart:math';
...
class _SessionPageState extends State<SessionPage> {
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  //     MaterialPageRoute(
                                  //         builder: (context) =>
                                  //             JoinSession(user: widget.user, roomID: sessionCode)));
                                },
                                style: ElevatedButton.styleFrom(
                                    foregroundColor: Colors.blue,
                                    backgroundColor: Colors.white,
  ...
  void showMeetingCodeDialog(BuildContext context, String user, String sessionCode) {
    double Height = MediaQuery.of(context).size.height;
    double Width = MediaQuery.of(context).size.width;
        ...
        child: Container(
          ...
          child: TextButton(
            ...
            onPressed: () {
              ...
              //     context,
              //     MaterialPageRoute(
              //         builder: (context) => SessionLoading(user: widget.user, roomID: sessionCode,)));
            },
          ),
        ),
      ),
